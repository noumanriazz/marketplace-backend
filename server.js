...
const miningMachineRoutes = require("./routes/miningMachine");
const miningOrderRoutes = require("./routes/miningOrder");
...
app.use("/api/mining-machines", miningMachineRoutes);
app.use("/api/mining-orders", miningOrderRoutes);
